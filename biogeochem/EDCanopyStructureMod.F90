...
contains
  ...
  ! ============================================================================
   subroutine canopy_structure( currentSite , bc_in )
      ...
      ! We iterate because of possible imprecisions generated by the cohort
      ! termination and fusion processes.  These should generally be small, but allow up to 20 
      ! iterations for cases where cohorts at the boundary between canopy layers are large, and thus the
      ! error associated with fusing them is appreciable

      integer, parameter  :: max_patch_iterations = 20
